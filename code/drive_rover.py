...
class RoverState():
    def __init__(self):
        self.modes = ['PickRock','decongest','stop','resume','forward']
        ...
        self.internal_start = 0 #counter start
        self.blockade = 0
        self.next = 'forward'
        self.prev_pos = None
        ...
        self.decon_error = 0
        self.unmapped = np.zeros((160,320),dtype=np.uint8)
